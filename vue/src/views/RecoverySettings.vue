		...
		<div class="">
			<div v-if="currentPage === 1">
				<div class="title-container has-text-left mb-20">
					...
					<h2 class="text-white text-2xl ml-3 font-semibold">{{ $t('recovery.ACCOUNT_RECOVERY') }}</h2>
				</div>
				<div class="white__container settings__container">
					...
					<div class="has-text-left mt-5 is-size-7">
						<p class="has-text-weight-bold text-xl"><i class="fas fa-shield-alt"></i> {{ $t('recovery.ADD_ACCOUNT_TIP_TITLE') }}</p>
						<p class="text_sm">
