...
<template>
  <div>
    <div>
      <h2 v-if="!hideOldPassword" class="title">
        {{ $t("password.CHANGE_PASSWORD_TITLE") }}
      </h2>
    ...
    <div class="container card">
      ...
      <div v-if="currentPage === 1">
        <div>
          ...
          <p data-cy="passwordChangeDescription" class="text-xl">
          ...
          <button
            @click="resetData"
            tag="button"
            class="button outline-white big-button transition-faster"
          >
