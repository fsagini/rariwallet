...
<template>
  <div>
    <div
      v-for="transaction in withdrawnTransactions"
      :key="transaction.id"
...
export default class withdrawnTransactions extends mixins(Global) {
  ...
  withdrawnTransactions = this.transactions.filter((transaction) => {
    return transaction.transactionType === "Withdrawn";
  });
}
</script>
<!-- eslint-disable prettier/prettier -->
