<template>
  <div>
    ...
    <img
      ...
      :alt="$t('images.PASSWORD_IMAGE')"
      class="confirm__img"
    />
    <div class="white__container">
      <h2 class="text-black text-xl font-semibold mt-5">
        {{ $t("confirm.CONFIRM_ACCESS_TITLE") }}
      </h2>
      <p data-cy="confirmAccessTitle" class="text-sm text-black pl-5 pr-5">
