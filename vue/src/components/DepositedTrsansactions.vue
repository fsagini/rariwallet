...
<template>
  <div>
    <div
      v-for="transaction in depositedTransactions"
      :key="transaction.id"
...
export default class DepositedTransactions extends mixins(Authenticated) {
  ...
  depositedTransactions = this.transactions.filter((transaction) => {
    return transaction.transactionType === "Deposited";
  });
}
</script>
<!-- eslint-disable prettier/prettier -->
