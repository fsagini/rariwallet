<template>
  <div>
    <div class="banner__img">
      <img
        v-if="
          (twoFaRequired.email || twoFaRequired.needConfirmation) &&
          !twoFaRequired.authenticator
        "
        src="@/assets/img/auth/emailbanner-removebg-preview.png"
        alt="Email 2FA image"
        class="mb-3"
      />
      <img
        v-if="twoFaRequired.authenticator"
    ...
    <div class="container figma">
      ...
      <h2 data-cy="verificationTitle" class="title title__mt">
      ...
      <p
        v-if="
          twoFaRequired.authenticator &&
          !twoFaRequired.email &&
          !twoFaRequired.needConfirmation
        "
        class="subtitle"
      >
      ...
      <form v-on:submit.prevent="validateCode" novalidate>
        ...
        <div class="error" v-if="logonError">
          <p>⚠️ <span class="text-black" v-html="logonError"></span></p>
        </div>

        <button
          class="button big-button is_login transition-faster mt-5"
          type="submit"
          data-cy="unlock"
        >
