		...
		<div class="figma">
			...
			<form class="flex justify-center flex-col align-middle">
				<div class="w-60 py-4 border-b-2 border-blue-500 ml-10">
					<input type="text" class="px-4 outline-none bg-inherit text-sm font-semibold" placeholder="Amount of coins to withdraw" />
				</div>
				<div class="w-60 py-4 border-b-2 border-blue-500 ml-10">
					<label class="text-lg font-serif font-semibold">You Will Receive</label>
					<input type="text" disabled class="px-4 outline-none bg-inherit text-sm font-semibold" />
				</div>
				<div class="w-60 py-4 border-b-2 border-blue-500 ml-10">
