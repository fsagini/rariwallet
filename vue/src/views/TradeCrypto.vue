<template>
	<div class="container">
		<h2 class="title">BUY CRYPTO COINS WITH M-PESA</h2>
		<div class="action">
			<button @click="pageBack">BACK</button>
		</div>
		<p data-cy="buyCryptoTitle" class="sub__title">List of supported crypto coins with Real-time Market Price</p>
		<div></div>
